...
const en = {
  ...
  schedule: {
    ...
    cancel: 'Cancel',
    checkIn: 'Check in',
    checkedIn: 'Checked in. See you on the mat!',
    empty: 'No classes scheduled in the next two weeks.',
    loading: 'Loading the schedule…',
    error: 'Could not load the schedule.',
    actionError: 'Could not update your booking. Please try again.',
    bookingStatus: { booked: 'Booked', waitlisted: 'Waitlisted' },
  },
  attendance: {
    title: 'My attendance',
    when: 'When',
    method: 'Checked in by',
    empty: 'No attendance recorded yet.',
    loading: 'Loading…',
    error: 'Could not load your attendance.',
    methodValue: {
      self: 'You',
...
const sv = {
  ...
  schedule: {
    ...
    cancel: 'Avboka',
    checkIn: 'Checka in',
    checkedIn: 'Incheckad. Vi ses på mattan!',
    empty: 'Inga klasser inplanerade de närmaste två veckorna.',
    loading: 'Läser in schemat…',
    error: 'Kunde inte läsa in schemat.',
    actionError: 'Kunde inte uppdatera din bokning. Försök igen.',
    bookingStatus: { booked: 'Bokad', waitlisted: 'Väntelista' },
  },
  attendance: {
    title: 'Min närvaro',
    when: 'När',
    method: 'Incheckad av',
    empty: 'Ingen närvaro registrerad ännu.',
    loading: 'Läser in…',
    error: 'Kunde inte läsa in din närvaro.',
    methodValue: {
      self: 'Du',
