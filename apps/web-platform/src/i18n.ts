...
const sv = {
  ...
  nav: { tenants: 'Organisationer', audit: 'Granskningslogg', dashboard: 'Plattform' },
  login: {
    title: 'Logga in',
    email: 'E-post',
    password: 'Lösenord',
    submit: 'Logga in',
    error: 'Inloggningen misslyckades. Kontrollera din e-post och ditt lösenord.',
  },
  tenants: {
    ...
    status: 'Status',
    created: 'Skapad',
    loading: 'Läser in organisationer…',
    empty: 'Inga organisationer registrerade ännu.',
    error: 'Kunde inte läsa in organisationer — du kanske saknar plattformsbehörighet.',
    view: 'Visa',
  },
  tenant: {
    back: 'Organisationer',
    ...
    loading: 'Läser in…',
    error: 'Kunde inte läsa in organisationen.',
  },
  audit: {
    title: 'Plattformens granskningslogg',
    intro: 'Endast tillägg; en hash-kedjad logg över plattformens läsningar mellan organisationer.',
    when: 'När',
    actor: 'Aktör',
    action: 'Åtgärd',
    target: 'Mål',
    ip: 'IP',
    loading: 'Läser in granskningsloggen…',
    empty: 'Ingen plattformsaktivitet registrerad ännu.',
    error: 'Kunde inte läsa in granskningsloggen.',
  },
  statusValue: { active: 'Aktiv', suspended: 'Avstängd', archived: 'Arkiverad' },
};
const nb = {
  ...en,
